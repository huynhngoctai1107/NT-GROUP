        ...
        <div class="wrapper">
            <div class="content-wrapper">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <x-admin.buttom.add :router="$page=='posts'?'listPosts':''" :name="$page=='posts'?'Danh sách bài viết':''"></x-admin.buttom.add>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($query as $item)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('restorePost', $item->slug)}}" class="btn btn-outline-primary btn-sm">Khôi phục</a>
                                    </td>
                                </tr>
                            @endforeach
                            @if (isset($message))
