                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($data as $item)
                                <tr>
                                    ...
                                    <td></td>
                                    <td>
                                        <a href="{{route('editFormBlog',$item->slug)}}" class="btn btn-outline-success btn-sm">Sửa</a>

                                        <a href="{{route('deleteBlog',$item->slug)}}" class="btn btn-outline-danger btn-sm">Xóa</a>
                                    </td>
                                </tr>
                            @endforeach
                            @if (isset($message))
