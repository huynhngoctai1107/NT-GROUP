    ...
    <div class="hold-transition sidebar-mini">
        <div class="wrapper">
            <div class="content-wrapper">
                <form action="{{route('addBlog')}}" method="post" class="mx-5 pt-4" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        @error('title')
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="summernote1" name="excerpt">{{ old('excerpt') }}</textarea>
                    </div>
                    <div class="form-group">
                        @error('content')
                        <div class="alert alert-danger mt-3">{{ $message }}</div>
