                                        ...
                                        <tr>
                                            <td class="pad">
                                                <div align="center" class="alignment" style="line-height:10px">
                                                    <img alt="Resetting Password" class="fullWidth" src="https://media.istockphoto.com/id/1281150061/vector/register-account-submit-access-login-password-username-internet-online-website-concept.jpg?s=612x612&w=0&k=20&c=9HWSuA9IaU4o-CK6fALBS5eaO1ubnsM08EOYwgbwGBo=" style="display: block; height: auto; border: 0; max-width: 374px; width: 100%;" title="Resetting Password" width="374"/>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            <td class="pad" style="text-align:center;width:100%;">
                                                <h1 style="margin: 0; color: #101010; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 27px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;">
                                                    <strong><span class="tinyMce-placeholder">THÔNG BÁO
                                                                            ĐĂNG NHẬP</span></strong></h1>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                            ...
                                            <td class="pad" style="padding-bottom:10px;padding-left:20px;padding-right:10px;padding-top:30px;">
                                                <div style="font-family: sans-serif">
                                                    <div class="" style="font-size: 12px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 21.6px; color: #848484; line-height: 1.8;">
                                                        <p style="margin: 0; color: #0c0c0d; font-size: 14px; text-align: center;padding-bottom:10px; mso-line-height-alt: 32.4px;">
                        <span style="font-size:18px;">XIN
                                CHÀO BẠN: <strong class="text-dark"> {{$data['fullname']}}</strong></span></p>
                                                        <p style="margin: 0; font-size: 14px; color: #0c0c0d; text-align: left; mso-line-height-alt: 25.2px;">
                                                            <strong class="text-dark">Đăng nhập lúc:
                                                                <em>{{$data['time']}}</em></strong>
                                                        </p>
                                                        <p style="margin: 0; font-size: 14px; color: #0c0c0d; text-align: left; mso-line-height-alt: 25.2px;">
                                                            <strong class="text-dark">Địa chỉ Addpress:
                                                                <em>{{$data['version']}}  </em></strong></p>
                                                        <p style="margin: 0; font-size: 14px; color: #0c0c0d; text-align: left; mso-line-height-alt: 25.2px;">
                                                            <strong class="text-dark">Hệ điều hành máy:
                                                                <em>{{$data['platform']}}  </em></strong></p>
                                                        <p style="margin: 0; font-size: 14px; color: #0c0c0d; text-align: left; mso-line-height-alt: 25.2px;">
                                                            <strong class="text-dark">Hệ điều hành máy:
                                                                <em>{{$data['device']}}  </em></strong></p>
                                                        <p style="margin: 0; font-size: 14px; color: #0c0c0d; text-align: left; mso-line-height-alt: 25.2px;">
                                                            <strong class="text-dark">Đăng nhập bằng trình duyệt:
                                                                <em>{{$data['browser']}}</em></strong><strong><br/><br/><span style="color:#464646;">CÁM ƠN BẠN
