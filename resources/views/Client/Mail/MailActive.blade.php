                                        ...
                                        <tr>
                                            <td class="pad">
                                                <div style="color:#a0ac94;direction:ltr;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:150%;text-align:center;mso-line-height-alt:21px;">
                                                    <p style="margin: 0;">Chào mừng bạn đến với website của chúng tôi !</p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <td class="column column-1" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 30px; padding-left: 50px; padding-right: 50px; padding-top: 20px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="100%">
                                    <table border="0" cellpadding="10" cellspacing="0" class="heading_block block-1" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                                        <tr>
                                            <td class="pad">
                                                <h2 style="margin: 0; color: #393d47; direction: ltr; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; font-size: 23px; font-weight: 400; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">Chào <strong style="font-weight: bold;">{{$data['fullname']}}</strong> đã đăng ký thành công tài khoản. Bạn có 15 phút để kích hoạt tài khoản. Xin vui lòng kích hoạt để đăng nhập vào tài khoản! ✨🍂🌻</span></h2>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            <td class="pad" style="padding-bottom:20px;padding-top:30px;">
                                                <div style="color:#393d47;direction:ltr;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:180%;text-align:left;mso-line-height-alt:28.8px;">
                                                    <p style="margin: 0;">Bất Động Sản Kiên Giang là một trong những công ty chuyên về đầu tư xây dựng và phân phối bất động sản đất nền. Đây là một trong những công ty có tuổi đời trẻ nhưng đã khẳng định được vị thế của mình trên thị trường bất động sản Miền Nam – Tp. Kiên Giang 💃🎉<br/>Song song với việc chú trọng phát triển các hoạt động kinh doanh,Động Sản Kiên Giang cũng luôn chú tâm đến các hoạt động xã hội, tích cực thể hiện thông điệp “Vững Nền Tảng, Chắc Tương Lai”.🌸🌿</p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
