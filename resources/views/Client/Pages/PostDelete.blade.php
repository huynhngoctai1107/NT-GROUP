                                    ...
                                    <div class="product_header_left">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton2">
                                                <li><a class="dropdown-item active" href="{{route('postNew')}}">Tin đã đăng</a></li>
                                                <li><a class="dropdown-item" href="{{route('postList')}}">Tin mua vip</a></li>
                                                <li><a class="dropdown-item" href="{{route('postDelete')}}">Tin đã xóa</a></li>
