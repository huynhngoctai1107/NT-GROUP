            ...
            <div class="container mb-5 mt-5">
                <div class="row">
                        ...
                        <form>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="name"
                                       placeholder="Ví dụ: Nguyễn Duy Hòa" required>
                            </div>
                            <div class="mb-3">
                                <label for="phone" class="form-label text-dark">Số điện thoại</label>
                                <input type="tel" class="form-control" id="phone" name="phone"
                                       placeholder="Ví dụ: 0123456789" required>
                            </div>
                            <div class="mb-3">
                                <label for="email" class="form-label text-dark">Email</label>
                                <input type="email" class="form-control" id="email" name="email"
                                       placeholder="Ví dụ: Duyhoa2001@gmail.com" required>
                            </div>
                            <div class="mb-3">
                                <label for="address" class="form-label text-dark">Địa chỉ</label>
                                <input type="text" class="form-control" id="address" name="address"
                                       placeholder="Ví dụ: 123 Hoàng Quốc Việt, An Bình, Ninh Kiều, Cần Thơ" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <span class="mb-4 text-sm">Chúng tôi đảm bảo sẽ không tiết lộ bất cứ thông tin nào của
                                bạn!</span>
                            <button type="submit" class="btn btn-warning form-control mt-3">Gửi</button>
                        </form>
                        <div class="row mt-4">
                            <div class="col-md-3">
                    ...
                    <div class="col-lg-6 pt-2 pt-lg-0 mt-4 mt-lg-0">
                        ...
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3929.594872460719!2d105.0979252746503!3d9.967624673591734!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31a0b43853857f1d%3A0x6b5909aaf0a7e39!2zUGhhbiBUaOG7iyBSw6BuZywgQW4gSMOyYSwgVHAuIFLhuqFjaCBHacOhLCBLacOqbiBHaWFuZywgVmnhu4d0IE5hbQ!5e0!3m2!1svi!2s!4v1694403931948!5m2!1svi!2s"
                            width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"
                            referrerpolicy="no-referrer-when-downgrade" id="map" class="contact_map2"></iframe>
                    </div>
                </div>
            </div>
        </div>
