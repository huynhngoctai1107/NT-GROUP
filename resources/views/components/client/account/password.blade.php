            ...
            <form method="POST" action="{{ route('updatePassword', auth()->user()->token) }}" id="update_password" enctype="multipart/form-data" class="contactForm">
                ...
                <div class="row">
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control @error('current_password') is-invalid @enderror" value="{{ auth()->user()->password }}" id="old-password" name="current_password" placeholder="Nhập mật khẩu cũ của bạn">
